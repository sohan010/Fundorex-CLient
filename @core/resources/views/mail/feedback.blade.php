...
<div class="mail-container">
    ...
    <div class="inner-wrap">
        ...
        <table>
            ...
            <tr>
                <td>{{get_static_option('feedback_page_form_email_label')}}</td>
                <td>{{$data['feedback']->email}}</td>
            </tr>
            <tr>
                <td>{{get_static_option('feedback_page_form_ratings_label')}}</td>
                <td>{{$data['feedback']->ratings}}</td>
            </tr>
            <tr>
                <td>{{get_static_option('feedback_page_form_description_label')}}</td>
