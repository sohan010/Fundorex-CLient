    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{$form_title}}</h4>
                        @if($notice && $notice_type)
                        <div class="alert alert-{{$notice_type}} alert-block ">
                            <strong><i class="ti-hand-point-right mr-1"></i> {{$notice}}</strong>
                        </div>
                        @endif
                        <form action="{{$action}}" method="Post">@csrf
                            {!! render_drag_drop_form_builder_markup($field_name) !!}
