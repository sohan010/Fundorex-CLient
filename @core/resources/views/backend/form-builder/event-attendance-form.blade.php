...
@section('site-title')
    {{__('Event Attendance Form Builder')}}
@endsection
@section('style')
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Event Attendance Form Builder")}}</h4>

                        <form action="{{route('admin.form.builder.event.attendance.form')}}" method="Post">@csrf
                            {!! render_drag_drop_form_builder_markup(get_static_option('event_attendance_form_fields')) !!}
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4 margin-bottom-40"
                                    id="save">{{__('Save Change')}}</button>
                        </form>
                    </div>
                </div>
            </div>
