            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.home.five.success.story.area')}}" method="post" enctype="multipart/form-data">
                            @csrf

                            <div>
                                <div class="form-group">
                                    <label>{{__('Title')}}</label>
                                    <input type="text" name="home_page_05_success_story_area_title" class="form-control"
                                           value="{{get_static_option('home_page_05_success_story_area_title')}}">
                                </div>
                                <div class="form-group">
                                    <label>{{__('Subtitle')}}</label>
                                    <input type="text" name="home_page_05_success_story_area_subtitle" class="form-control"
                                           value="{{get_static_option('home_page_05_success_story_area_subtitle')}}">
                                </div>
