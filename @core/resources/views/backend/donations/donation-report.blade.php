    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Donation Report")}}</h4>
                        <form action="{{route('admin.donations.report')}}" method="get" enctype="multipart/form-data" id="report_generate_form">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($data->status == 'pending')
                                                        <span class="alert alert-warning text-capitalize">{{str_replace('-',' ',$data->status)}}</span>
                                                    @else
                                                        <span class="alert alert-success text-capitalize">{{str_replace('-',' ',$data->status)}}</span>
                                                    @endif
                                                </td>
