        ...
        <nav class="navbar sticky-top navbar-white bg-white">
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 mx-auto">
                <div class="input-group">
                    ...
                    <input id="search-top" class="form-control border-end-0 border rounded-pill" type="text" placeholder="Sudah berdonasi hari ini?">
                    <span class="input-group-append"><i class="bi bi-search search-icon"></i></span>
                </div>
            </div>
        </nav>
    </div>
                ...
                @if(auth()->check())
                 ...
                 @else
                    <li class="nav-item">
                       ...
                       {{__('Login')}}</a> <span>/</span> <a href="{{route('user.register')}}">{{__('Register')}}</a>
                    </li>
                 @endif
                </li>
