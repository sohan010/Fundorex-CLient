...
<div class="contatiner">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 mx-auto">
                <nav class="navbar sticky-top navbar-white bg-white">
                    ...
                    <div class="input-group custom-top">
                        <form action="{{route('frontend.donation.search')}}" method="get" class="custom-form-design">
            ...
            <div class="row text-center pt-4">
                @foreach($all_donation_category as $data)
                    <div class="col category">
                        <a href="{{route('frontend.donations.category', $data->id )}}">
                            {!! render_image_markup_by_attachment_id($data->image) !!}
                            <span class="small d-block textMenuBottom">{{$data->title ?? ''}}</span>
                        </a>
                    </div>
                @endforeach
            </div>
    ...
    <div class="row mb-100 pl-25 pr-15">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 mx-auto CampaignMendesak pt-4">
            <h6 class="judul">{{ get_static_option('donation_single_popular_donation_text') }}</h6>
            ...
            <span class="wrapLihatSemua">
                    <a href="{{route('frontend.donations')}}" class="lihatSemuaCampaign">Lihat semua</a>
                </span>

            <div class="scrolling-wrapper row mt-4 pb-4 pt-2 contentResponsive">
                @foreach($featured_causes as $data)
    ...
    <div class="row mb-100 pl-25 pr-15">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 mx-auto CampaignMendesak ">
            <h6 class="judul">{!! get_static_option('home_page_blog_area_title') !!}</h6>
            <h6 class="judulh6">{!! get_static_option('home_page_blog_area_subtitle') !!} </h6>
            <span class="wrapLihatSemua">
                    <a href="{{route('frontend.blog')}}" class="lihatSemuaCampaign">{{__('See All')}}</a>
            </span>
                            ...
                            <div class="single-blog-items">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-contents">
                                        ...
                                        <h4 class="blog-title"> <a href="{{route('frontend.blog.single',$data->slug)}}" class="main-title"> {{$data->title  ?? __("Anonymous")}} </a> </h4>
                                        <p> {!! Str::words(purify_html_raw($data->blog_content),45) !!} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <ul class="navbar-nav nav-justified w-100">
                ...
                <li class="nav-item active">
                    <a href="{{url('/')}}" class="nav-link text-center">
                        ...
                        <span class="small d-block textMenuBottom">{{get_static_option('menu_home')}}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link text-center">
                        ...
                        <span class="small d-block textMenuBottom">{{get_static_option('menu_recent_donation')}}</span>
                    </a>
                </li>
                <li class="nav-item">

                    <a href="{{route('frontend.pre.payment.page')}}" class="nav-link text-center">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link text-center">
                        ...
                        <span class="small d-block textMenuBottom">{{get_static_option('menu_my_donation')}}</span>
                    </a>
                </li>
                ...
                @if(auth()->check())
                    ...
                    <li class="nav-item">
                        <a href="{{$route}}">
                            ...
                            <span class="small d-block textMenuBottom">{{get_static_option('menu_profile')}}</span>
                        </a>
                        <a href="{{ route('frontend.user.logout') }}" class="my-3">
                            {{ __('Logout') }}
                        </a>
