        ...
        <div id="notfound">
            <div class="notfound">
                <div class="notfound-404">
                    <h1>{{get_static_option('error_404_page_title')}}</h1>
                </div>
                <h2>{{get_static_option('error_404_page_subtitle')}}</h2>
                <p>{{get_static_option('error_404_page_paragraph')}}</p>
                <a href="{{route('homepage')}}">{{get_static_option('error_404_page_button_text')}}</a>
            </div>
        </div>
    </body>
</html>
