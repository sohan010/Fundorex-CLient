        ...
        <div class="package-info-wrap">
            @if(!empty($payment_details))
                ...
                <ul>
                    ...
                    <li><strong>{{__('Package Price')}}</strong> {{amount_with_currency_symbol($payment_details->package_price,true)}}</li>
                    <li><strong>{{__('Package Description')}}</strong> {{$payment_details->order_id}}</li>
                </ul>
            @endif
        </div>
    </div>
