    ...
    <section class="support-ticket-page-area my-5">
        <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-8">
                   <a href="<?php echo e(url('/')); ?>" class="pull-right btn btn-info text-white"><?php echo e(__('Go Home')); ?></a>
...
<?php endif; ?>
                           <form action="<?php echo e(route('frontend.support.ticket.store')); ?>" method="post" class="support-ticket-form-wrapper" enctype="multipart/form-data">
                              ...
                              <div class="btn-wrapper text-center">
                                  <button type="submit" class="btn btn-primary"><?php echo e(get_static_option('support_ticket_button_text')); ?></button>
                              </div>
                           </form>
                       <?php else: ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\fundorex-indonesian-client\@core\resources\views/frontend/pages/support-ticket/support-ticket.blade.php ENDPATH**/ ?>