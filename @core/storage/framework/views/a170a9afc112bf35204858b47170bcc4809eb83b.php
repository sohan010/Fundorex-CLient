            ...
            <div class="notfound">
                <div class="notfound-404">
                   ...
                   <?php if(isset($message)): ?>
                    ...
                    <?php else: ?>
                        <h3><?php echo e(__('Permission Denied !')); ?></h3>
                        <p><?php echo e(__('Does not have permission to access this page')); ?></p>
                        <a href="<?php echo e(route('admin.home')); ?>"><?php echo e(__('back to home')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/fundorex/@core/resources/views/errors/403.blade.php ENDPATH**/ ?>